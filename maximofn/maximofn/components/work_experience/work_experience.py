...
from maximofn.styles.work_experience_styles import work_experience_title_style, work_experience_style, work_experience_stack_style_desktop, work_experience_stack_style_mobile_and_tablet

def work_experience_title () -> rx.Component:
    return rx.text(
        "Experiencia laboral",
...
def work_experience() -> rx.Component:
    ...
    row_start_indra = row_start_arquimea_electronic + 1
    ...
    return rx.vstack(
        ...
        rx.desktop_only(
            rx.vstack(
                ...
                style = work_experience_stack_style_desktop,
            ),
        ),
        rx.mobile_and_tablet(
            rx.vstack(
                ...
                #     num_rows=num_rows,
                # ),
                style = work_experience_stack_style_mobile_and_tablet,
            ),
        ),
