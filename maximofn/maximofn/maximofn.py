...
from maximofn.components.politica_de_cookies import politica_de_cookies
...
app.add_page(proyecto_test1, route="/proyecto_test1")
app.add_page(politica_de_cookies, route="/politica_de_cookies")
app.compile()
