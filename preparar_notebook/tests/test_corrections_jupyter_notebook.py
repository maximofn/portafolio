...
if not PASS_TESTS:
    class Test_corrections_jupyter_notebook(unittest.TestCase):
        ...
        def test_apply_corrections(self):
            pass
        def test_apply_corrections_empty_line(self):
            pass
        def test_apply_corrections_space_line(self):
            pass
        def test_apply_corrections_tab_line(self):
            pass
        def test_apply_corrections_return_line(self):
            pass
        def test_apply_corrections_example1(self):
            pass
        def test_apply_corrections_example2(self):
            pass
        def test_apply_corrections_example3(self):
            pass
        def test_apply_corrections_example4(self):
            pass
        def test_apply_corrections_example5(self):
            pass
        def test_apply_corrections_example6(self):
            pass
